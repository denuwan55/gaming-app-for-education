...
import 'package:quiz_app/Widgets/Puzzle/Core/app_colors.dart';
import 'package:quiz_app/Widgets/Puzzle/Core/app_string.dart';
import 'package:quiz_app/Widgets/Puzzle/Presentation/Flutter%20%20Pluzzle/Widgets/button.dart';
import 'package:quiz_app/Widgets/Puzzle/Model/object_model.dart';
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                ...
                                if (showText && !success)
                                  TextInCircleAvater(slideObject: slideObject),
                              ],
                            ),
                            // nice one
                          ),
